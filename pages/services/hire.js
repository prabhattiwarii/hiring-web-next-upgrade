...
& .wrapimage { background-image: url('/images/hddbg.jpg'); width: 100%;display: flex;left: 20px; background-size: cover;min-height: 550px;    color: #fff;font-size: 60px;padding-top: 10px;left:0px;}
...
`
const Bottam = styled.div`& .wrapmain{display:flex;flex-direction:column;row-gap:20px;align-items:center;justify-content:center;
& .wrapchoose{padding: 10px 30px;display: inline-block; border-radius: 10px;font-size: 18px;font-weight: 600; color: #1589F1;margin-bottom: 15px;background-color: #EBF5FF;}
& .wrapchoose1{ font-size:25px;font-weight:700;}
}
& .mainwrapdetail{padding:30px; display: grid;grid-template-columns: repeat(3, 1fr); justify-content:center; align-items:center; flex-direction:column;row-gap:50px;
& .wrap{display:flex;  flex-direction:row; column-gap:20px; align-items:center;background-color:whitesmoke;padding:10px;}
}
`
const Bottam1 = styled.div`& .wrapmain{display:flex;flex-direction:column;row-gap:20px;align-items:center;justify-content:center;
  & .wrapchoose{padding: 10px 30px;display: inline-block; border-radius: 10px;font-size: 18px;font-weight: 600; color: #1589F1;margin-bottom: 15px;background-color: #EBF5FF;}
  & .wrapchoose1{ font-size:25px;font-weight:700;}
  }
  & .mainwrapdetail{padding:30px; display: grid;grid-template-columns: repeat(5, 1fr); justify-content:center; align-items:center; flex-direction:column;row-gap:50px;
  & .wrap{display:flex;  flex-direction:column; row-gap:20px; align-items:center;padding:10px;transition: .5s; background-color: #f4f8fc;margin-bottom: 25px;text-align: center;padding: 15px;}
  }
  `
  const Bottam2 = styled.div`& .wrapmain{display:flex;flex-direction:column;row-gap:20px;align-items:center;justify-content:center;
    & .wrapchoose{padding: 10px 30px;display: inline-block; border-radius: 10px;font-size: 18px;font-weight: 600; color: #1589F1;margin-bottom: 15px;background-color: #EBF5FF;}
    & .wrapchoose1{ font-size:25px;font-weight:700;    position: relative; color: #1589F1;display: inline-block;margin-bottom: 30px; background-color: #EBF5FF; padding: 10px 30px;border-radius: 10px;font-style: normal;font-weight: 500; font-size: 25px; line-height: 38px;}
    }
    & .mainwrapdetail{padding:30px; display: grid;grid-template-columns: repeat(5, 1fr); justify-content:center; align-items:center; flex-direction:column;row-gap:50px;
    & .wrap{display:flex;  flex-direction:column; row-gap:20px; align-items:center;padding:10px;transition: .5s; background-color: #f4f8fc;margin-bottom: 25px;text-align: center;padding: 15px;}
    }
...
const hire = () => {
  return (
    <Layout>
      ...
      <Main>
        <div className='wrapimage'>Hire Dedicated Developers</div>
      </Main>
        ...
        <AndroidSection>
          <div className='wrapbox'>
            ...
            <div className='wrapbackbox'>
              ...
              <div className='white'>Lets Discuss Support@cjtech.in</div>
            </div>
      ...
      <Bottam>
        <div className='wrapmain'>
          <div className='wrapchoose'>Why Choose Us</div>
          <div className='wrapchoose1'>C-J Tech Is your Development Partner</div>
        </div>
      ...
      <Bottam1>
        <div className='wrapmain'>
          ...
          <div className='wrapchoose1'>Hire Expert Developer - A Simplistic & Flexible Process</div>
        </div>
      ...
      <Bottam2>
        <div className='wrapmain'>
          ...
          <div className='wrapchoose1'>Highly Qualified and Dedicated Developers For Hire</div>
        </div>
          ...
          {maindata1.map((item) => (
            <div key={item.id}>
              ...
              <div className='wrap'>
                <img className='wrapimagework' src={item.image} alt={item.title} style={{ width: "", height: '' }} />
                <div className='wrapmain1'>{item.title}</div>
                <div className='wrapmain2'>{item.description}</div>
              </div>
            </div>
          ))}
        </div>

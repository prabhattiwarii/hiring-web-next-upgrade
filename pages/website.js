...
& .wrapimage { background-image: url('/images/laravelbg.jpg'); width: 100%;display: flex;left: 20px; background-size: cover;min-height: 550px;    color: #fff;font-size: 60px;padding-top: 10px;left:0px;}
...
const Website = () => {
    return (
        <Layout>
            <Main>
                <div className='wrapimage'>Laravel Development</div>
            </Main>
